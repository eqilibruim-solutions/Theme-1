...
class website(models.Model):
    ...
    order_minimum_amount = fields.Float( string="Order Minimum Amount")
...
class ResConfigSettings(models.TransientModel):
    ...
    order_minimum_amount = fields.Float(related="website_id.order_minimum_amount", readonly=False, string="Order Minimum Amount", config_parameter="order_minimum_amount")
